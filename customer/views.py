...
def remove_from_wishlist(request, id):
    ...
    messages.success(request, "Удалено из вашего вишлиста")
...
def add_to_wishlist(request, id):
    if request.user.is_authenticated:
        ...
        return JsonResponse({"message": "Товар добавлен в вишлист", "wishlist_count": wishlist.count()})
    else:
        return JsonResponse({"message": "Пользователь не вошёл в систему", "wishlist_count": "0"})
